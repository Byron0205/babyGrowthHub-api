...
const Multimedia = {
    insertarMultimedia: async (req, res) => {
        const { NombreRecuerdo, IDEtapa, TipoArchivo, RutaArchivo, IDAlbum, IDBebe } = req.body;
        ...
        try {
            connection.execute(
                query,
                [IDMultimedia, NombreRecuerdo, IDEtapa, TipoArchivo, RutaArchivo, fechaSubida, IDAlbum, IDBebe],
