...
routerConsultas.get("/adultos/:IDAdulto", adultosController.obtenerAdultosPorID);
...
routerConsultas.put("/adultosxbebe/:IDBebe", adultosController.modificarRolConsultaPanel);
